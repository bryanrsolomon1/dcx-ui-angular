// (function(){
//     "use strict";
//     function LogDecorator($delegate, ENVIRONMENT, ENVIRONMENT_DEV){
//         "ngInject";
//
...
//                 function metadata(){
//
//                     /* get timestamp using moment and pad values so all stamps look the same */
//                     var today = moment();
//                     var timestamp = pad(2, today.hours()) +
//                                     ":" + pad(2, today.minutes()) +
//                                     ":" + pad(2, today.seconds()) +
//                                     ":" + pad(3, today.milliseconds());
//
//                     var lineNumber = "";
//                     if(level !== "error" && ENVIRONMENT === ENVIRONMENT_DEV) {
//                         /*
